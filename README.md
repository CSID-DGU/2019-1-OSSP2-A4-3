...
#### 팀원
2014112081 정세인 : 모델 학습 데이터셋 수집, Food 데이터셋 수집 및 데이터베이스 구축, 어플리케이션 기능, 최종보고서 작성.<br>
2015112120 임성두 : 모델 학습 데이터셋 수집, Food 데이터셋 수집, 발표.<br>
2015112109 탁성환 : 모델 학습, 모델 변환, 모델 정확도 체크 및 향상(transfer,Fine tuning), 최종보고서 작성. <br>
2017112154 응웬딩흐엉 : 어플리케이션 기능, 어플리케이션 디자인, 데이터베이스 연결 및 구축.<br>
<br>
<br>
...
#### 프로젝트 설명
 ...
 주로 한식인 식사류 36종과 약과를 포함한 디저트류 16종을 포함하여 총 52종의 음식의 인식을 지원한다.<br>
...
2. 구글 드라이브 링크로 들어가 모델을 다운로드 후 Android-TensorFlow/app/src/main/assets/ 에 저장.<br>
